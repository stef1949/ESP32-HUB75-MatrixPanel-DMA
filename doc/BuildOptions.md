...
| **HUB75_WOKWI_SIM** | Enable a simulation backend for Wokwi. This bypasses the real DMA/I2S/LCD scanout path and instead streams an RGB framebuffer over UART1 to a Wokwi custom chip. | Intended for simulator use only. Do **not** enable this on physical HUB75 hardware. |
